    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-foreground-soft leading-relaxed">
          {/* 1. About LocalLane */}
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">1. About LocalLane</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">3. Community Pass Membership</h2>
            <p className="mb-3">
            ...
            <p className="mb-3">
              <span className="text-foreground font-medium">Nature of product:</span> Community Pass
            ...
            <p className="mb-3">
              <span className="text-foreground font-medium">No cash value:</span> Joy Coins have no cash
              or set monetary value. They cannot be exchanged for money, refunded, or applied toward
              purchases.
            </p>
            <p className="mb-3">
              <span className="text-foreground font-medium">Ownership of fees:</span> Membership fees
              become LocalLane's revenue upon receipt. LocalLane is not holding funds on behalf of
              members or businesses.
            </p>
            <p className="mb-3">
              <span className="text-foreground font-medium">No business entitlement:</span> Participating
            ...
            <p className="mb-3">
              <span className="text-foreground font-medium">Expiration and non-transferability:</span>{' '}
            ...
            <p className="mb-3">
              <span className="text-foreground font-medium">Prohibited uses:</span> Members may not
              transfer, sell, gift, cash out, or redeem Joy Coins for monetary value. Peer-to-peer
              transfer of Joy Coins is not permitted.
            </p>
            <p>
              <span className="text-foreground font-medium">Regulatory statement:</span> LocalLane is
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">4. Auto-Renewal and Cancellation</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">5. Business Subscriptions</h2>
            <p className="mb-3">
          ...
          {/* 6. Direct Purchases */}
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">6. Direct Purchases</h2>
            <p>
          ...
          {/* 8. AI Features */}
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">8. AI Features</h2>
            <p className="mb-3">
          ...
          {/* 9. Community Conduct */}
          <section>
            <h2 className="text-xl font-semibold text-foreground mb-3">9. Community Conduct</h2>
            <p className="mb-3">
