...
export const WORKSPACE_TYPES = {
  ...
  finance: {
    ...
    label: 'Finance',
    icon: 'DollarSign',
    description: 'See where your money goes and what you need each month',
    archetypeSupport: false,
  ...
  fieldservice: {
    ...
    label: 'Field Service',
    icon: 'HardHat',
    description: 'Your companion in the field — clients, estimates, and projects',
    archetypeSupport: false,
    networkAffinity: false,
    available: true,
  ...
  property_management: {
    ...
    icon: 'Building2',
    description: 'Keep your properties healthy — tenants, maintenance, and finances',
    archetypeSupport: false,
    networkAffinity: false,
    available: true,
