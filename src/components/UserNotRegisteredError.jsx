...
const UserNotRegisteredError = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-slate-950">
      <div className="max-w-md w-full p-8 bg-slate-900 rounded-lg shadow-lg border border-slate-800">
        <div className="text-center">
          ...
          <div className="p-4 bg-slate-800 rounded-md text-sm text-slate-300">
