...
export default function FinancialWidget({ business }: FinancialWidgetProps) {
  const tierLabels = {
    free: 'Free',
    silver: 'Silver',
    gold: 'Gold'
  ...
  const tierLabel = tierLabels[business.subscription_tier as keyof typeof tierLabels] || 'Free';
